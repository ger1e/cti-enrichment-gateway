...
This adapter is isolated behind `gateway_client.py` and `mapper.py` so the Maltego transport can be replaced with the current SDK later without changing the CTI gateway contract or provider integrations.
