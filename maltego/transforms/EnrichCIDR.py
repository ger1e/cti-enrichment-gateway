...
@registry.register_transform(
    display_name='CTI Enrich CIDR',
    input_entity='maltego.Phrase',
    description='Enrich a canonical IPv4 or IPv6 network prefix such as 192.0.2.0/24 through the private CTI enrichment gateway.',
