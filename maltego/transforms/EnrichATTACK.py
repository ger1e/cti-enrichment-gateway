...
@registry.register_transform(
    display_name='CTI Enrich MITRE ATT&CK',
    input_entity='maltego.Phrase',
    description='Enrich a MITRE ATT&CK identifier such as T1059.001 or G0007 through the private CTI enrichment gateway.',
