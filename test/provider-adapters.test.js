...
const cases = [
  ...
  [hybridAnalysisProvider, { value: 'a'.repeat(64), type: 'hash' }, { sha256s: ['a'.repeat(64)], reports: [{ id: 'r1', environment_id: 160, state: 'SUCCESS', verdict: 'malicious' }] }, { HYBRID_ANALYSIS_API_KEY: SECRET }, 'www.hybrid-analysis.com', '/api/v2/search/hash', 'GET'],
