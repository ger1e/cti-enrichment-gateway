...
import { buildReleaseManifest, serializeReleaseManifest } from '../scripts/generate-release-manifest.mjs';
...
test('committed release manifest exactly matches deterministic registry projection', () => {
  assert.equal(committed(), serializeReleaseManifest({ sourceCommit: null }));
});
