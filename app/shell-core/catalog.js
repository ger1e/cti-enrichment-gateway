...
const commands = [
  ...
  command('investigation.capture-operator', ['investigation', 'capture', 'operator'], 'investigation', 'investigation capture operator', 'capture the current Shodan or User Scanner result as context', { aliases: [['inv', 'capture', 'operator']], surfaces: WEB, sideEffect: 'session', handler: 'investigation-capture-operator', outputType: 'record' }),
